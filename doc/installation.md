...
Download the init script (will be /etc/init.d/gitlab_ci):
    ...
    sudo wget https://raw.github.com/gitlabhq/gitlab-ci/2-1-stable/lib/support/init.d/gitlab_ci -P /etc/init.d/
...
Download an example site config:
    ...
    sudo wget https://raw.github.com/gitlabhq/gitlab-ci/2-1-stable/lib/support/nginx/gitlab_ci -P /etc/nginx/sites-available/
